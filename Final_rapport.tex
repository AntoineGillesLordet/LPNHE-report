...
%%% Une synthèse d’une page (ou executive summary) présentant le problème posé et ses enjeux pour le client, les éléments clés de la démarche, les solutions apportées et les résultats obtenus, et ce, en français et en anglais
...
\subsection{Reformulation du problème dans son contexte}


\section{Approche et analyse}

\subsection{État de l'art}
%% méthodes, raisons des choix faits, analyses menées (état de l’art)

\subsubsection{Analyse du clustering des galaxies pour mesurer $f\sigma_8$}
...
\subsubsection{Analyse cosmologique avec des SN Ia}
\label{sec:art}
...
\subsubsection{Mesurer $f\sigma_8$ avec le clustering des galaxies et les SN de type Ia}
...
\subsubsection{Approche de résolution du problème}
%% présentation détaillée de l’approche de résolution de problème retenue, des ressources scientifiques, techniques et humaines mises en oeuvre, de l’organisation du travail
...
\subsubsection{Génération des SN Ia et reconstruction des vitesses particulières}
...
\subsection{Résultats intermédiaires et finaux visés}
%% présentation des résultats intermédiaires et finaux visés

\subsection{Difficultés rencontrées}
%% exposé des difficultés rencontrées et de la façon dont elles ont été surmontées
...
\subsection{Gestion des risques réalisée}
%% gestion des risques réalisée (????)


\section{Résultats}
%% présentation détaillée des résultats effectivement obtenus en les reliant au problème qui était à traiter et mettant en exergue 
% la validité des résultats par rapport au problème
% le caractère innovant / neuf des résultats
% l’utilité des résultats, l’usage effectif qui sera fait du travail de l’élève ingénieur
% la mise en exergue des limites du travail et des suites à donner à ce travail
% la quantification et/ou qualification de la valeur ajoutée


\section{Travail futur}
%o prolongements possibles du travail de stage : exposé de ce qu’il reste éventuellement à faire pour que les résultats soient complètement obtenus, et de la façon dont le travail pourra être poursuivi par l’entreprise dans le futur


\section{Bilan personnel}
%o bilan des principaux apprentissages professionnels et leur mise en perspective pour le futur professionnel

\section{Enjeux éthiques}
%o prise de recul sur les enjeux d’ordre éthique
