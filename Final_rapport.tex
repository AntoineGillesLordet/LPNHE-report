...
\usepackage[backend=biber, style=apa, maxcitenames=2, uniquelist=false, uniquename=false]{biblatex}  
...
\renewcommand\maketitle{\begin{titlepage}
	...
	\begin{center}%
		...
		{\large \@date \par}%
		\vskip 2em%
		\includegraphics[height=3cm]{figures/logo_lpnhe.png} \\[1cm]
		\includegraphics[height=3cm]{figures/CentraleSupélec Quadri UPSaclay.png}
	\end{center}\par
	\@thanks
	\vfil\null
\end{titlepage}%
...
\title{Rapport final de stage de fin d'études\\[.3em] \LARGE Mesure de la croissance des structures avec les galaxies du DESI BGS et les supernovae de type Ia de ZTF~: vers une analyse jointe}
\author{ \large Antoine Gilles--Lordet\\[.1em] encadré par Pauline Zarrouk et Nicolas Regnault }
...
Je tiens à remercier l'ensemble du LPNHE et tout particulièrement le groupe cosmologie, pour l'accueil qu'ils m'ont réservés pour mon projet de troisième année puis mon stage de fin d'études. Ce fut un véritable plaisir de travailler avec mes encadrants, Pauline Zarrouk et Nicolas Regnault, et bien que je parte effectuer ma thèse à Stockholm, j'espère que j'aurai d'autres occasions de collaborer avec eux. Je remercie également Thomas De Jaeger, Dylan Kuhn et Mahmoud Osman pour leurs aides multiples sur l'utilisation des modules \pets, \edris et \nacl, et Marc Betoule pour ses explications très claires sur toutes les méthodes d'analyses utilisées.
